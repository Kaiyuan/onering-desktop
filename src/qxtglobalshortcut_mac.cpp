...
quint32 QxtGlobalShortcutPrivate::nativeKeycode(Qt::Key key)
{
    ...
    qDebug() << "keyboardTypeCount:" << header->keyboardTypeCount;
	...
	qDebug() << "charTable->keyToCharTableCount =" << charTable->keyToCharTableCount;
        for (quint32 j=0; j < charTable->keyToCharTableCount; j++)
        {
		qDebug() << "j:" << j;
            UCKeyOutput* keyToChar = reinterpret_cast<UCKeyOutput*>(data + charTable->keyToCharTableOffsets[j]);
	    qDebug() << "keyToCharTableSize =" << charTable->keyToCharTableSize;
...
bool QxtGlobalShortcutPrivate::registerShortcut(quint32 nativeKey, quint32 nativeMods)
{
	...
	qDebug() << "InstallApplicationEventHandler";
    ...
    qDebug() << "RegisterEventHotKey" << nativeKey << nativeMods;
